...
def tryout():
    try_input = raw_input("Please input the number of lives, between 1-10: ")
    if int(try_input) in range(1,11):
...
def difficulty():
    ...
    if user_dif == "1-Easy" or user_dif == "1" or user_dif == "Easy":
        print "\nLet's begin!!\n"
        print text_easy
        return game(text_easy, answers_easy) #game inputs are set on easy mode.
    elif user_dif == "2-Medium" or user_dif == "2" or user_dif == "Medium":
        print "\nLet's begin!!\n"
        print text_medium
        return game(text_medium, answers_medium) #game inputs are set on medium mode.
    elif user_dif == "3-Hard" or user_dif == "3" or user_dif == "Hard":
        print "\nLet's begin!!\n"
        print text_hard
